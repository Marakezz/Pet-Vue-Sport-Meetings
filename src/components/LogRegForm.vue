...
<template>
  <div class="mx-10 mt-4 p-2 border-solid border-gray-500 border-2 rounded-md text-center">
    <div v-if="!isChosenTypeOfEntry">
      <button @click="loginClicked" class="bg-zinc-200 font-bold mr-4 border-separate border-2">
        Вход
      </button>
    ...
    <div v-if="isLoggining && isChosenTypeOfEntry">
      <form @submit.prevent="">
        ...
        <input
          ...
          type="text"
          placeholder="Name"
          class="mr-4 border-separate border-2"
        />
        <input
        ...
        />
        <button
          class="bg-zinc-200 font-bold border-separate border-2"
